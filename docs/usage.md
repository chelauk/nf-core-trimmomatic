# nf-core/trimmomatic: Usage

## :warning: Please read this documentation on the nf-core website: [https://nf-co.re/trimmomatic/usage](https://nf-co.re/trimmomatic/usage)
...
```console
nextflow run nf-core/trimmomatic --input samplesheet.csv --genome GRCh37 -profile docker
```
...
```console
nextflow pull nf-core/trimmomatic
```
...
First, go to the [nf-core/trimmomatic releases page](https://github.com/nf-core/trimmomatic/releases) and find the latest version number - numeric only (eg. `1.3.1`). Then specify this when running the pipeline with `-r` (one hyphen) - eg. `-r 1.3.1`.
